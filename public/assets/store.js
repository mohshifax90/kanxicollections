...
const Store = window.Store = (() => {
  ...
  function seed() {
    const cats = [
      { id:'c_cloth', name:'Clothing', slug:'clothing', icon:'shirt', image:'', active:true, variantType:'size', cardType:'portrait', brands:[], title:'Clothing & Apparel', description:'Curated fashion crafted from premium fabrics — tailored blazers, silk dresses and effortless co-ords designed to elevate your everyday wardrobe with timeless elegance.' },
      { id:'c_skin',  name:'Skincare', slug:'skincare', icon:'sparkles', image:'', active:true, variantType:'volume', cardType:'square', brands:[], title:'Skincare & Beauty', description:'Science-backed, clean formulas that nourish and glow. From brightening serums to deep hydration, discover skincare made to love your skin every single day.' },
      { id:'c_make',  name:'Makeup',   slug:'makeup',   icon:'palette', image:'', active:true, variantType:'shade', cardType:'square', brands:[], title:'Makeup & Colour', description:'Bold shades and silky textures for every look. Long-wear lipsticks, luminous foundations and blushes in colours made to flatter.' },
      { id:'c_bags',  name:'Bags',     slug:'bags',     icon:'shopping-bag', image:'', active:true, variantType:'none', cardType:'square', brands:[], title:'Bags & Accessories', description:'Handcrafted leather and canvas bags built to last. Structured totes, sleek crossbodies and weekend carryalls — timeless pieces for the modern individual.' },
      { id:'c_watch', name:'Watches',  slug:'watches',  icon:'watch', image:'', active:true, variantType:'none', cardType:'square', brands:[], title:'Watches & Timepieces', description:'Precision engineering meets refined design. From minimalist classics to bold complications, mark every moment with a Kanxi timepiece built to endure.' },
    ];
    const subs = [
  ...
  function normalize(db){
    ...
    if(!hp.header || typeof hp.header !== 'object') hp.header = { ...defaultHomepage().header };
    hp.header.logo = sanitizeImage(hp.header.logo);
